...
class Sparks:
    def __init__(self, num_particles):
        dims = 2
        self.locations = rand(num_particles, dims)
        self.velocities = randn(num_particles, dims)*3
    ...
    def step(self):
        ...
        self.velocities += randn(*self.velocities.shape) * 0.05
        self.ages += self.dt
